  ...
  return (
    <section className="main">
          ...
          <div className="social-icon">
            <ul className="list-inline mb-0 d-flex align-items-center">
              <li className="list-inline-item">
                <a
                  href="https://www.facebook.com/samorzadstudenckipl"
                  target="_blank"
                >
                  <svg
                    width="9"
              ...
              <li className="list-inline-item">
                <a href="https://twitter.com/SamorzadStudPL" target="_blank">
                  <svg
                    width="18"
                    height="15"
                    viewBox="0 0 18 15"
              ...
              <li className="list-inline-item">
                <a
                  href="https://www.instagram.com/samorzadstudencki_pl/"
                  target="_blank"
                >
                  <svg
                    width="18"
      ...
      <section className="xs-bg d-md-none d-lg-none">
        <img src="./assets./xs.jpg" alt="img" className="img-fluid w-100" />
      </section>
